...
class Scan:
    ...
    def generateSinogram(self):  # The patient's reference frame is stationary, detector's reference frame
        ...
        path_resolution = 100  # How many data points for each beam/detector cell
        ...
        for angle_index,angle in enumerate(angles):
            for t_index,t in enumerate(lines_t):
                ...
                sinogram_data[t_index,angle_index] = [angle,t,integral]
        return np.transpose(sinogram_data[:,:,2])
